    ...
    <div>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-20 left-10 w-72 h-72 bg-rose-200/30 rounded-full blur-xl animate-pulse"></div>
          <div className="absolute top-40 right-20 w-96 h-96 bg-pink-200/40 rounded-full blur-2xl animate-pulse delay-1000"></div>
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
          ...
          {/* Elegant Info Card */}
          <div className="bg-white/15 backdrop-blur-lg border border-white/20 rounded-2xl p-8 mb-12 shadow-2xl">
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-5xl font-serif font-light text-center text-gray-800 mb-16">
            Wedding Details
          </h2>
          <div className="grid md:grid-cols-3 gap-10">
            <div className="group bg-white rounded-2xl shadow-xl p-10 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border border-rose-100">
              ...
              <div className="space-y-2">
                <p className="text-rose-600 font-semibold text-lg">2:00 PM</p>
            ...
            <div className="group bg-white rounded-2xl shadow-xl p-10 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border border-rose-100">
              ...
              <div className="space-y-2">
                <p className="text-rose-600 font-semibold text-lg">3:00 PM</p>
      ...
      {/* Countdown Section */}
      <section className="py-24 bg-gradient-to-r from-rose-50 via-pink-50 to-purple-50 relative overflow-hidden">
        {/* Background decoration */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-10 left-10 w-32 h-32 bg-rose-300 rounded-full blur-xl"></div>
          <div className="absolute bottom-10 right-10 w-40 h-40 bg-pink-300 rounded-full blur-xl"></div>
        </div>

        <div className="max-w-6xl mx-auto text-center px-6 relative z-10">
          <h2 className="text-5xl font-serif font-light text-gray-800 mb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-rose-100 hover:scale-105 transition-transform duration-300">
              <div className="text-5xl font-serif font-bold bg-gradient-to-r from-rose-600 to-pink-600 bg-clip-text text-transparent mb-2">
                {timeRemaining.days}
              </div>
        ...
        <div className="max-w-5xl mx-auto text-center">
          <div className="mb-12">
            <div className="inline-block">
              <div className="w-16 h-0.5 bg-gradient-to-r from-transparent via-rose-400 to-transparent mb-6"></div>
            </div>
            <h2 className="text-5xl font-serif font-light text-gray-800 mb-6">
              Our Love Story
            </h2>
